...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between h-14 sm:h-16 px-3 sm:px-4 md:px-6 bg-background/80 backdrop-blur-xl border-b border-border">
